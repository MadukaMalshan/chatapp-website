...
let Latest_massage = "";
let gemini_response = '';
let PersonIndexArray = ["Gemini", "Ruvindu", "Sajith"];
let ChatList = [];
let ChatPerson = [[], [], []];
...
function response_by_gemini(){
    ...
    fetch("https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash-latest:generateContent?key=AIzaSyAy3SVJXi7Nb6Km14P6FWTdoLfRNdceCcQ", requestOptions)
    ...
    msgHTML = 
        `<div class="msg left-msg">
            <div class="msg-bubble">
                ...
                <div class="msg-text">${gemini_response}</div>
            </div>
        </div>`
